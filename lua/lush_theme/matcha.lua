...
local c = {
  -- references: https://github.com/sainnhe/everforest/blob/master/palette.md
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    lCursor                     { fg="#2c343a", bg="#978d79", },  -- Character under the cursor when |language-mapping| is used (see 'guicursor')
    ...
    Special                     { fg="#b5aa92", },  -- (*) Any special symbol
